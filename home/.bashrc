...
# make less quit if fits on one page -F and not enter termcap -X (no init and no cleanup afterwards)
LESS="-F"
...
if [ "$color_prompt" = yes ]; then
    ...
    PS1='\[\033[01;32m\]\u@\h\[\033[00m\] \[\033[01;34m\]\w $(if [[ $? = 0 ]];then echo "\[\033[01;34m\]";else echo "\[\033[01;31m\]";fi)\$ \[\033[00m\]'
    #default:
...
# notice that under mac os x there is no /usr/bin/dircolors and that for example ls doesn't have a --color arg.
...
# some brew bash completion goodies
